...
const _TOOLTIP_SCENE = preload("res://scenes/Player/inventory/item_tooltip.tscn")
const _CURSOR_SCENE  = preload("res://scenes/Player/inventory/cursor_held_item.tscn")
