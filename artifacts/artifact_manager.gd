...
const ARTIFACT_PATHS: Array[String] = [
	"res://artifacts/weighted_boots.tres",
	"res://artifacts/adrenal_syringe.tres",
	"res://artifacts/insurance_charm.tres",
	"res://artifacts/max_vitality.tres",
	"res://artifacts/focused_mind.tres",
]
